...
bot.on('guildMemberAdd', member => {
    ...
    let Membercount = member.guild.voiceChannel.find(`name`, "Membres: " + member.guild.memberCount);
    if (!Membercount) return member.guild.createChannel('Membres: ' + member.guild.memberCount, 'voice');
    Membercount.setName('Membres:' + member.guild.memberCount);
